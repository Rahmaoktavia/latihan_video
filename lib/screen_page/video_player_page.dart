...
import 'package:project_video/screen_page/video_detail.dart';
...
class _PageLatVideoState extends State<PageLatVideo> {
  ...
  Future<void> _fetchVideoData() async {
    try {
      final response = await http.get(Uri.parse('http://192.168.156.142/list_video/getVideo.php'));
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => VideoPlayerPage(
                      videoUrl: 'http://192.168.156.142/list_video/video_file/${_videoList[index].videoFile}',
              ...
              child: Row(
                children: [
                  _videoList[index].gambar.isNotEmpty
                    ...
                    child: Image.network(
                      'http://192.168.156.142/list_video/gambar/${_videoList[index].gambar}',
                      width: 100,
                      height: 100,
                      fit: BoxFit.cover,
                    ),
